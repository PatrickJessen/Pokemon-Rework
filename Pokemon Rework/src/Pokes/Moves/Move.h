...
enum class Moves
{
    ...
    BUBBLE, WATERGUN, BITE, WITHDRAW, SKULLBASH, HYDROPUMP, GUST, SAND_ATTACK, QUICK_ATTACK, WHIRLWIND, WING_ATTACK, AGILITY, MIRROR_MOVE, HYPER_FANG, FOCUS_ENERGY, SUPER_FANG, POUND,
    TRANSFORM, MEGA_PUNCH, METRONOME, PSYCHIC
};
